...
class GeoGNNModel(nn.Layer):
    ...
    def forward(self, atom_bond_graph, bond_angle_graph, perturb1=0,perturb2=0):
        """
        Build the network.
        """
        ...
        node_hidden = node_hidden + perturb1

        bond_embed = self.init_bond_embedding(atom_bond_graph.edge_feat)
        edge_hidden = bond_embed + self.init_bond_float_rbf(atom_bond_graph.edge_feat) + perturb2
